...
> [!note] dsh adaptation
> Ported from claude-obsidian (MIT, © 2026 AgriciDaniel) for the Lion-1209 dsh adaptation.
> Upstream product scripts referenced below are not bundled; filesystem and web operations map
> to the standard dsh fs/shell/web tools.
